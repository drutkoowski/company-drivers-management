...
class NewCandidate(FlaskForm):
    ...
    pesel_kandydata = IntegerField("Pesel: ", validators=[DataRequired(message="Brak lub zły format numeru pesel!"),NumberRange(00000000000,99999999999)])
    ...
    numer_karty_kierowcy = IntegerField("Numer karty kierowcy: ", validators=[DataRequired(message="Niepoprawny numer karty kierowcy!"), NumberRange(000000000000000,999999999999999)])
    data_wygasniecia_karty_kierowcy = DateField("Data wygaśniecia karty kierowcy: ", validators=[DataRequired(message="Brak daty wygaśniecia karty kierowcy!")])
